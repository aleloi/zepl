...
# Install necessary dependencies: curl for download, xz-utils to extract .xz archives
...
# Download and extract Zig 0.13.0 for aarch64
...
# Optional: show installed Zig version
ENTRYPOINT ["./zig-out/bin/repl"]